...
class CreativityBenchmark:
    ...
    def report(self, print_time: bool = ..., postag_distribution: bool = ..., heavyweight_metrics: bool = ..., n: int = ..., model: Incomplete | None = ..., tokenizer: Incomplete | None = ..., k: int = ..., word2vec_model: Incomplete | None = ...) -> BookReport: ...
